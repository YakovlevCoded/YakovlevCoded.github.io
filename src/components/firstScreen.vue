<template>
  <section class="main">
    <div class="container">
      ...
      <div class="subtitle">
        <p>
          <span class="subtitle__span">Илья Громозов:</span><br>
          10 Principes for <br>
          Good Design
        </p>
      </div>
      <div class="action">
        ...
        <div class="socials">
          <ul>
            ...
            <a href="https://vk.com/id480439822" target="_blank">
              <li class="vk">
            ...
            <a href="tel:8352624245" type="phone">
              <li class="call">
        ...
        <div class="gallery" @click="showMultiple" :style="{
    backgroundImage: 'url(' + require('@/assets/images/prewiew.png') + ')'
    }">
        </div>
        <vue-easy-lightbox :visible="visible" :imgs="imgs" :index="index - 1" @hide="handleHide"></vue-easy-lightbox>

        <h1 class="h1">
          <span class="color-red">Good Design</span> <br>
          Makes Product <br>
          Useful
        </h1>
      </div>
      <div class="description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum at dolorem dignissimos
        porro, maxime nostrum culpa ratione aperiam explicabo, ullam, qui aliquid error eveniet suscipit eligendi
        aliquam. Explicabo, quisquam numquam?</div>
    </div>
  </section>
</template>
